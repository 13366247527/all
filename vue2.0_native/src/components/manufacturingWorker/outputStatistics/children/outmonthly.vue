<template>
  <div class="common-page-flex">
		  ...
		  <ul class="common-bottom-box outmonthly">        
            	<li class="box-select">
		            	<span>月份查询：</span>
	...
	export default{
		...
		methods:{	
			...
			okFn(data){
				...
				document.getElementsByClassName('outmonthly')[0].style.height='-webkit-fill-available'
				setTimeout(function(){
					document.getElementsByClassName('outmonthly')[0].style.height=''
				},300)
				if(data != 1){
						this.$loading.open();
						this.dataTime = data
