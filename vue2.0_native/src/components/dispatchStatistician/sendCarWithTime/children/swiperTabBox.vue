...
export default {
  ...
  mounted() {
    this.mySwipr = new Swiper(".swiper-container", {
      initialSlide : this.$route.path === "/dispatchStatistician/sendCarWithTime/aboutCar" ? 0  : this.$route.path === "/dispatchStatistician/sendCarWithTime/menuCar" ? 1 : this.$route.path === "/dispatchStatistician/sendCarWithTime/carManage" ? 2 : this.$route.path === "/dispatchStatistician/sendCarWithTime/siteManage" ? 3 : 0,
      //autoHeight : true
    });
