...
export default {
  ...
  methods: {
    initPage(){
        this.nowIndex = this.$route.path === "/dispatchStatistician/billManagement/CollectionOfDocuments" ? 0  : this.$route.path === "/dispatchStatistician/billManagement/MoreThanOneCar" ? 1 : this.$route.path === "/dispatchStatistician/billManagement/OneCarAndManyLibraries" ? 2 : 0;
    },
    LMtabClick(index) { 
    ...
    LMslidetab(index) { 
        this.nowIndex = index
        this.title = this.tabbarList[index]
        let href = index == 0 ?  "/dispatchStatistician/billManagement/CollectionOfDocuments" : index === 1 ? "/dispatchStatistician/billManagement/MoreThanOneCar" : "/dispatchStatistician/billManagement/OneCarAndManyLibraries" 
