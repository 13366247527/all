...
export default {
  ...
  mounted() {
    this.mySwipr = new Swiper(".swiper-container", {
      initialSlide : this.$route.path === "/dispatchStatistician/billManagement/CollectionOfDocuments" ? 0  : this.$route.path === "/dispatchStatistician/billManagement/MoreThanOneCar" ? 1 : this.$route.path === "/dispatchStatistician/billManagement/OneCarAndManyLibraries" ? 2 : 0,
      //autoHeight : true
    });
