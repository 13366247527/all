<template>
  <div>
    <div class="common-page-flex">
      <ul class="commonTab" id="forms">
        ...
        <li>
          ...
          <div class="disFlex marLeft05">
            <span>电话：</span>
            <input type="text" class="wid135"   v-model="ownerMobile" @blur="tel(ownerMobile,'ownerMobile')">
          </div>
        </li>
        ...
        <li>
          <div>
            ...
            <input type="text" class="wid75" readonly :value="nowLoadWeight">
            <span class="meter">吨</span>
          </div>
          <div class="disFlex marLeft05">
            <span class="min75 disFlex">车长：</span>
            <input type="text" class="wid75" readonly :value="nowLength">
        ...
        <li>
          <div class="disFlex">
            ...
            <input type="text" class="wid75" readonly :value="nowWidth">
            <span class="meter">米</span>
          </div>
          <div class="disFlex marLeft05">
    ...
    <div class="common-bottom-button bottom-button-fixed">
      <span class="redBtner" @click="Determine(0)">车队</span>
      <span class="orangeBtn" @click="Determine(1)">合约车</span>
      <span class="greenBtner" @click="Determine(2)">临时车</span>
    </div>
  </div>
</template>
...
import { getCache } from "@/config/utils";
  ...
  methods: {
    ...
    Determine(index) {
     ...
     this.imgUploadInput = imgUploadInput.join(',')
      if(!this.vehtyp || !this.vehnum || !this.vehli || !this.imgUploadInput || !this.licenceDate || !this.personnam || !this.mobile){
        this.$toast('请先完善数据！')
        return
      }
