...
export default {
  ...
  mounted() {
    this.mySwipr = new Swiper(".swiper-container", {
      initialSlide : this.$route.path === "/vehicleDispatcher/deliveryManagement/VehicleCondition" ? 0  : this.$route.path === "/vehicleDispatcher/deliveryManagement/SigningManagement" ? 1 : this.$route.path === "/vehicleDispatcher/deliveryManagement/ResourceCollection" ? 2 : 0,
      //autoHeight : true
    });
