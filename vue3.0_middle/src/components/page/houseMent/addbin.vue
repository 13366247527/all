<template>
    <div>
        <div class="crumbs">
                ...
                <el-breadcrumb-item>添加库位</el-breadcrumb-item>
            </el-breadcrumb>
         </div>
        <div class="container">
            <span class="title">添加库位</span>
            <el-divider></el-divider>
            <p>库位信息</p>
            <el-form :label-position="labelPosition" label-width="80px" :model="form" class="forms" >
                <el-form-item label="库位编号"  required >
                    <el-input v-model="form.binid" placeholder="请输入库位编号" ></el-input>
                </el-form-item>
...
export default {
    ...
    methods:{
       ...
       submitMoveForm(){
           this.form.type = '1513'
           if(this.form.binarea&&this.form.num&&this.form.dnum&&this.form.binid&&this.form.bintype&&this.form.type){
           const data = new URLSearchParams();
            data.append('binNum',this.form.binid)
