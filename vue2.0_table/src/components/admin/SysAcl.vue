  ...
  <div class="container messageboard">
    ...
    <div class="con-box">
      ...
      :index="indexMethod" label="序号" align="center">
          ...
          <el-table-column prop="crdat" label="出单日期" min-width="12%" align="center" sortable></el-table-column>
          <el-table-column prop="tradocnum" label="装运单号" align="center" min-width="12%" sortable></el-table-column>
          <el-table-column prop="deldocnum" label="送货单号" align="center" min-width="12%" sortable></el-table-column>
          <el-table-column prop="outnam" label="客户" align="center" min-width="28%" sortable></el-table-column>
          <el-table-column prop="vehlicnum" label="车号" align="center" min-width="12%" sortable></el-table-column>
          <el-table-column prop="shpartqty" label="数量(箱)" align="center" min-width="12%" sortable></el-table-column>
          <el-table-column prop="totartwgt" label="重量(吨)" align="center" min-width="12%" sortable></el-table-column>
        </el-table>
      </div>
      <el-pagination
        background
