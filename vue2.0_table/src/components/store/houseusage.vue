  ...
  <div class="container messageboard">
    ...
    <div class="con-box">
      ...
      <div class="table_box1" id="table_box1">
        ...
        >
          <el-table-column prop="sortNum" label="面积（㎡）"  align="center"></el-table-column>
          <el-table-column prop="grade" label="利用率（%）" align="center" ></el-table-column>
          <el-table-column prop="nextDayCount" label="可存托数（托）" align="center" ></el-table-column>
          <el-table-column prop="timeoutCount" label="实存托数（托）" align="center" ></el-table-column>
          <el-table-column prop="overtimeCount" label="使用率（%）" align="center" ></el-table-column>
          <el-table-column prop="appointAmount" label="盘点时间" align="center"></el-table-column>
        </el-table>
      </div>
      <el-pagination
        background
