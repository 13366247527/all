  ...
  <div class="container messageboard">
    ...
    <div class="con-box">
      ...
      <div class="table_box1" id="table_box1">
        ...
        >
          <el-table-column prop="sortNum" label="库位"  align="center"></el-table-column>
          <el-table-column prop="grade" label="托数（托）" align="center" width="350"></el-table-column>
          <el-table-column prop="nextDayCount" label="数量（箱）" align="center" width="350"></el-table-column>
          <el-table-column prop="timeoutCount" label="生产日期" align="center" width="350"></el-table-column>
        </el-table>
      </div>
      <el-pagination
        background
