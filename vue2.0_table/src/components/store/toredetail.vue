    ...
    <div class="con-box">
      ...
      <div class="table_box1" id="table_box1">
        ...
        >
          ...
          <el-table-column prop="grade" label="瓶数（瓶）" align="center" ></el-table-column>
          <el-table-column prop="nextDayCount" label="破损率（%）" align="center"></el-table-column>
          <el-table-column prop="timeoutCount" label="同比（%）" align="center" ></el-table-column>
          <el-table-column prop="grade" label="环比（%）" align="center" ></el-table-column>
        </el-table>
      </div>
      <el-pagination
        background
