    ...
    <div class="con-box">
      ...
      <div class="table_box1" id="table_box1">
        ...
        >
          ...
          <el-table-column prop="nextDayCount" label="托数（托）" align="center" ></el-table-column>
          <el-table-column prop="timeoutCount" label="重量（吨）" align="center" ></el-table-column>
          <el-table-column prop="overtimeCount" label="生产日期" align="center" ></el-table-column>
          <el-table-column prop="appointAmount" label="差异数量" align="center"></el-table-column>
          <el-table-column prop="violationsCount" label="破损数量" align="center" ></el-table-column>
        </el-table>
      </div>
      <el-pagination
        background
